...
RESULTS_BASE="${RESULTS_BASE:-$BASE_DIR/results_stress_npu_warm_allmodels_temp_0_0_0_5_1_0}"
...
for TEST in "${STRESS_TESTS[@]}"; do
    ...
    TMPDIR=/tmp setsid stress-ng --temp-path /tmp $ARGS --metrics-brief > "$STRESS_LOG" 2>&1 &
